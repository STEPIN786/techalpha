   ...
   <div class="row">
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               <form class="forms-sample" method="POST" action="{{ route('product.category.store') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                  ...
                  <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input id="product_banner_image" type="file" class="form-control @error('product_banner_image') is-invalid @enderror" name="product_banner_image" value="" id="product_banner_image">
                            <div class="help-block with-errors" ></div>
