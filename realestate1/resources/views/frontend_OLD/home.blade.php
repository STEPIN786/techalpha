...
@endpush
  <body>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4">
            <div class="service-item shadow-hover">
              ...
              <h4>
                <a href="properties-for-sale-in-kondhawa-pune">Properties for Sell</a>
              </h4>
            </div>
          </div>
          <div class="col-lg-4 col-md-4">
            <div class="service-item shadow-hover">
              ...
              <h4>
                <a href="properties-on-rent-in-kondhawa-pune">Properties for Rent</a>
              </h4>
            </div>
          </div>
          <div class="col-lg-4 col-md-4">
            <div class="service-item shadow-hover">
              ...
              <h4>
                <a href="bungalows-and-rowhouses-in-pune">Bungalows & Row Houses</a>
              </h4>
            </div>
          </div>
        </div>
    ...
    <section class="module properties" style="background-color:#fafafa;">
      <div class="container">
          ...
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="buy-property-2bhk-aura-solis-wanowrie" class="property-img">
                ...
                <img src="images/property-img22.jpg" alt="Rental properties">
              </a>
              <a href="callto:+919890239777" class="btn default_btn">
                <i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price </a>
              <div class="property-content">
                <div class="property-title">
                  <h4>
                    <a href="buy-property-2bhk-aura-solis-wanowrie">2 BHK Aura Solis </a>
                  </h4>
                  <p class="property-address">
                    <i class="fa fa-map-marker icon" aria-hidden="true"></i>
                    <b>Wanowrie Annex, Pune</b>
                  </p>
                </div>
                <table class="property-details">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <i class="fa fa-expand" aria-hidden="true"></i> 1480 Sq Ft
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="buy-property-3bhk-aura-solis-wanowrie" class="property-img">
                ...
                <div class="property-color-bar"></div>
                <img src="images/property-img11.jpg" alt="Properties for sale">
              </a>
              <a href="callto:+919890239777" class="btn default_btn">
                <i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price </a>
              <div class="property-content">
                <div class="property-title">
                  <h4>
                    <a href="buy-property-3bhk-aura-solis-wanowrie">3 BHK - Aura Solis</a>
                  </h4>
                  <p class="property-address">
                    <i class="fa fa-map-marker icon" aria-hidden="true"></i>
                    <b>Wanowrie Annex, Pune</b>
                ...
                <table class="property-details">
                  <tbody>
                    <tr>
                      ...
                      <!--<td><i class="fa fa-tint"></i> 2 Baths</td>-->
                      <td>
                        <i class="fa fa-expand" aria-hidden="true"></i> 17000 Sq Ft
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="property-3bhk-raheja-gardan" class="property-img">
                ...
                <!--<div class="property-price">RS.1.60cr Nego</div>-->
                <div class="property-color-bar"></div>
                <img src="images/property-img43.jpg" alt="Properties for sale">
              </a>
              <a href="callto:+919890239777" class="btn default_btn">
                <i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price </a>
              <div class="property-content">
                <div class="property-title">
                  <h4>
                    <a href="buy-property-3bhk-raheja-garden.php">3 BHK - Raheja Garden</a>
                  </h4>
                  <p class="property-address">
                    <i class="fa fa-map-marker icon" aria-hidden="true"></i>
                    <b>Wanowrie, Pune</b>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="buy-property-2.5bhk-gulmohar-gesidency" class="property-img">
                ...
                <div class="property-color-bar"></div>
                <img src="images/property-img51.jpg" alt="Best Property dealers " />
              </a>
              <a href="callto:+919890239777" class="btn default_btn">
                <i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price </a>
              <div class="property-content">
                <div class="property-title">
                  <h4>
                    <a href="buy-property-2.5bhk-gulmohar-gesidency">2.5 BHK - Gulmohar Residency </a>
                  </h4>
                  <p class="property-address">
                ...
                <table class="property-details">
                  <tr>
                    <td>
                      <i class="fa fa-bed"></i> 2.5 Beds
                    </td>
                    <!--<td><i class="fa fa-tint"></i> 2 Baths</td>-->
                    <td>
                      <i class="fa fa-expand"></i> 1995 Sq Ft
                    </td>
                  </tr>
                </table>
              </div>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="buy-property-4.5bhk-shobha-carnation" class="property-img">
                ...
                <!--<div class="property-price">RS.10,000</div>-->
                <div class="property-color-bar"></div>
                <img src="images/property-img63.jpg" alt="Best Property dealers " />
              </a>
              <a href="callto:+919890239777" class="btn default_btn">
                <i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price </a>
              <div class="property-content">
                <div class="property-title">
                  <h4>
                    <a href="buy-property-4.5bhk-shobha-carnation">4.5 BHK - Shobha Carnation</a>
                  </h4>
                  <p class="property-address">
                    <i class="fa fa-map-marker icon"></i>
                    <b>Kondhwa, Pune</b>
                ...
                <table class="property-details">
                  <tr>
                    <td>
                      <i class="fa fa-bed"></i> 4.5 Beds
                    </td>
                    <!--<td><i class="fa fa-tint"></i> 2 Baths</td>-->
                    <td>
                      <i class="fa fa-expand"></i> 2850 Sq Ft flat + 2000 Sq Ft Garden
                    </td>
                  </tr>
                </table>
              </div>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="buy-property-3bhk-kumar-prince-town-royel" class="property-img">
                ...
                <!--<div class="property-price">RS.10,000</div>-->
                <div class="property-color-bar"></div>
                <img src="images/property-img73.jpg" alt="Best Property dealers " />
              </a>
              <a href="callto:+919890239777" class="btn default_btn">
                <i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price </a>
              <div class="property-content">
                <div class="property-title">
                  <h4>
                    <a href="buy-property-3bhk-kumar-prince-town-royel">3 BHK - Kumar Prince Town Royal </a>
                  </h4>
                  <p class="property-address">
                    <i class="fa fa-map-marker icon"></i>
                    <b>Kondhwa, Pune</b>
                ...
                <table class="property-details">
                  <tr>
                    ...
                    <!--<td><i class="fa fa-tint"></i> 2 Baths</td>-->
                    <td>
                      <i class="fa fa-expand"></i> 1350 Sq Ft Carpet
                    </td>
                  </tr>
                </table>
              </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="buy-property-3.5-bhk-penthouse" class="property-img">
                <div class="img-fade"></div>
                <!--<div class="property-price">RS.10,000</div>-->
                <div class="property-color-bar"></div>
                <img src="images/property-img81.jpg" alt="Best Property dealers " />
              </a>
              <a href="callto:+919890239777" class="btn default_btn">
                <i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price </a>
              <div class="property-content">
                <div class="property-title">
                  <h4>
                    <a href="buy-property-3.5-bhk-penthouse">3.5 BHK - Penthouse </a>
                  </h4>
                  <p class="property-address">
                    <i class="fa fa-map-marker icon"></i>
                    <b>Pune</b>
                ...
                <table class="property-details">
                  <tr>
                    <td>
                      <i class="fa fa-bed"></i> 3.5 Beds
                    </td>
                    <!--<td><i class="fa fa-tint"></i> 2 Baths</td>-->
                    <td>
                      <i class="fa fa-expand"></i> 2290 Sq Ft + Terrace + Car Park
                    </td>
                  </tr>
                </table>
              </div>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="buy-property-3bhk-brand-flat" class="property-img">
                <div class="img-fade"></div>
                <!--<div class="property-price">RS.10,000</div>-->
                <div class="property-color-bar"></div>
                <img src="images/property-img91.jpg" alt="Best Property dealers " />
              </a>
              <a href="callto:+919890239777" class="btn default_btn">
                <i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price </a>
              <div class="property-content">
                <div class="property-title">
                  <h4>
                    <a href="buy-property-3bhk-brand-flat">3 BHK - Brand Flat </a>
                  </h4>
                  <p class="property-address">
                    <i class="fa fa-map-marker icon"></i>
                    <b>Undri, Pune</b>
                ...
                <table class="property-details">
                  <tr>
                    ...
                    <!--<td><i class="fa fa-tint"></i> 2 Baths</td>-->
                    <td>
                      <i class="fa fa-expand"></i> 1350 Sq Ft
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <section class="module properties" style="background-color:#fff;">
      <div class="container">
        <div class="module-header">
          <h2>Properties <strong> for Rent</strong>
          </h2>
          ...
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="buy-property-2bhk-aura-solis-wanowrie" class="property-img">
                ...
                <!--<div class="property-price">RS. 1.45cr nego </div>-->
                <div class="property-color-bar"></div>
                <img src="images/property-img1.jpg" alt="Rental properties">
              </a>
              <a href="callto:+919890239777" class="btn default_btn">
                <i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price </a>
              <div class="property-content">
                <div class="property-title">
                  <h4>
                    <a href="buy-property-2bhk-aura-solis-wanowrie">Property Name </a>
                  </h4>
                  <p class="property-address">
                    <i class="fa fa-map-marker icon" aria-hidden="true"></i>
                    <b>Wanowrie Annex, Pune</b>
    ...
    <section class="module testimonials">
      <div class="container">
        <div class="module-header">
          <h2>Our <strong>Testimonials</strong>
          </h2>
        </div>
      </div>
        ...
        <div class="slider slider-testimonials">
          <div class="testimonial slide">
            ...
            <div class="testimonial-details">
              <!--<img class="testimonial-img" src="images/testimonial-img.png" alt="Best Property dealers " />-->
          ...
          <div class="testimonial slide">
            ...
            <div class="testimonial-details">
              <!--<img class="testimonial-img" src="images/testimonial-img.png" alt="Best Property dealers " />-->
              <p class="testimonial-name">
                <strong>Renuka Suryavanshi</strong>
              </p>
              <span class="testiomnial-title"></span>
            </div>
          </div>
          <div class="testimonial slide">
            <h3>"I thank Manmiet and his team for helping us to purchase our flat in Pune. He runs a most professional agency and was very responsive to all my queries. He made sure that I got the best deal and ensured that all formalities were completed in the limited time available to me to complete the deal. Thanks and God bless"</h3>
            <div class="testimonial-details">
              <!--<img class="testimonial-img" src="images/testimonial-img.png" alt="Best Property dealers " />-->
              <p class="testimonial-name">
                <strong>Edson rebello</strong>
              </p>
              <span class="testiomnial-title"></span>
            </div>
          </div>
          <div class="testimonial slide">
            ...
            <div class="testimonial-details">
              <!--<img class="testimonial-img" src="images/testimonial-img.png" alt="Best Property dealers " />-->
              <p class="testimonial-name">
                <strong>Rudrayani Shedjale</strong>
              </p>
              <span class="testiomnial-title"></span>
            </div>
          </div>
    ...
    <section class="module properties">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="commercial-properties-kondhawa-pune" class="property-img">
                <div class="img-fade"></div>
                <div class="property-color-bar"></div>
                <img src="homeloan/office1.jpg" alt="Best real-estate agent" />
              </a>
            </div>
          </div>
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="commercial-properties-kondhawa-pune" class="property-img">
                <div class="img-fade"></div>
                <div class="property-color-bar"></div>
                <img src="homeloan/office2.jpg" alt="real-estate agents in kondhwa" />
              </a>
            </div>
          </div>
          <div class="col-lg-4 col-md-4">
            <div class="property shadow-hover">
              <a href="commercial-properties-kondhawa-pune" class="property-img">
                <div class="img-fade"></div>
                <div class="property-color-bar"></div>
                <img src="homeloan/office3.jpg" alt="real-estate broker in kondhwa" />
              </a>
            </div>
          </div>
        </div>
