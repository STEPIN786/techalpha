    ...
    <div class="row">
      <div class="col-lg-4 col-md-4">
        <div class="service-item shadow-hover">
          ...
          <h4><a href="{{ route('front-sell-list') }}">Properties for Sell</a></h4>
        </div>
      </div>
      <div class="col-lg-4 col-md-4">
        <div class="service-item shadow-hover">
          <i class="fa fa-building"></i>
          <h4><a href="{{ route('front-rent-list') }}">Properties for Rent</a></h4>
        </div>
      </div>
      <div class="col-lg-4 col-md-4">
        <div class="service-item shadow-hover">
          <i class="fas fa-vihara"></i>
          <h4><a href="{{ route('front-properties-list', 'bungalows-row-houses') }}">Bungalows & Row Houses</a></h4>
        </div>
      </div>
    </div><!-- end row -->
  </div><!-- end container -->
  ...
  <div class="container">
    ...
    <div class="module-header">
     ...
     <div class="row">
        ...
        @foreach($sell_properties as $sell_property)
        <div class="col-lg-4 col-md-4">
          <div class="property shadow-hover">
            <a href="buy-property-2bhk-aura-solis-wanowrie" class="property-img">
              <div class="img-fade"></div>
              <div class="property-color-bar"></div>
              <img src="{{ $sell_property->property_images }}" alt="Rental properties">
            </a>
            <a href="callto:+91{{ $sell_property->phone }}" class="btn default_btn"><i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price</a>
            <div class="property-content">
              <div class="property-title">
              <h4><a href="{{ $sell_property->detail_link }}">{{ $sell_property->title }}</a></h4>
              <p class="property-address"><i class="fa fa-map-marker icon" aria-hidden="true"></i><b>{{ $sell_property->address }}</b></p>
              </div>
              @if(false)
        ...
        <div class="col-lg-4 col-md-4">
          <div class="property shadow-hover">
            <a href="buy-property-3bhk-aura-solis-wanowrie" class="property-img">
              ...
              <div class="property-color-bar"></div>
              <img src="{{ env('ASSET_URL1') }}/public/frontend/images/property-img11.jpg" alt="Properties for sale">
            </a>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="property shadow-hover">
            <a href="property-3bhk-raheja-gardan" class="property-img">
              ...
              <!--<div class="property-price">RS.1.60cr Nego</div>-->
              <div class="property-color-bar"></div>
              <img src="{{ env('ASSET_URL1') }}/public/frontend/images/property-img43.jpg" alt="Properties for sale">
            </a>
            <a href="callto:+919890239777" class="btn default_btn"><i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price</a>
            <div class="property-content">
              <div class="property-title">
        ...
        <div class="col-lg-4 col-md-4">
          <div class="property shadow-hover">
            <a href="buy-property-2.5bhk-gulmohar-gesidency" class="property-img">
              ...
              <div class="property-color-bar"></div>
              <img src="{{ env('ASSET_URL1') }}/public/frontend/images/property-img51.jpg" alt="Best Property dealers " />
            </a>
             <a href="callto:+919890239777" class="btn default_btn"><i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price</a>
         ...
         <div class="col-lg-4 col-md-4">
          <div class="property shadow-hover">
            <a href="buy-property-4.5bhk-shobha-carnation" class="property-img">
              ...
              <!--<div class="property-price">RS.10,000</div>-->
              <div class="property-color-bar"></div>
              <img src="{{ env('ASSET_URL1') }}/public/frontend/images/property-img63.jpg" alt="Best Property dealers " />
            </a>
             <a href="callto:+919890239777" class="btn default_btn"><i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price</a>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="property shadow-hover">
            <a href="buy-property-3bhk-kumar-prince-town-royel" class="property-img">
              ...
              <!--<div class="property-price">RS.10,000</div>-->
              <div class="property-color-bar"></div>
              <img src="{{ env('ASSET_URL1') }}/public/frontend/images/property-img73.jpg" alt="Best Property dealers " />
            </a>
             <a href="callto:+919890239777" class="btn default_btn"><i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price</a>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="property shadow-hover">
            <a href="buy-property-2bhk-aura-solis-wanowrie" class="property-img">
              <div class="img-fade"></div>
              <div class="property-color-bar"></div>
              <img src="{{ $rent_property->property_images }}" alt="Rental properties">
            </a>
            <a href="callto:+91{{ $rent_property->phone }}" class="btn default_btn"><i class="fa fa-phone" aria-hidden="true"></i>Call Us To Get Price</a>
            <div class="property-content">
              <div class="property-title">
              <h4><a href="{{ $rent_property->detail_link }}">{{ $rent_property->title }}</a></h4>
              <p class="property-address"><i class="fa fa-map-marker icon" aria-hidden="true"></i><b>{{ $rent_property->address }}</b></p>
              </div>
              @if(false)
              <table class="property-details">
                <tbody><tr>
    ...
    <div class="slider slider-testimonials">
      ...
      <div class="testimonial slide">
        ...
        <div class="testimonial-details">
          <!--<img class="testimonial-img" src="{{ env('ASSET_URL1') }}/public/frontend/images/testimonial-img.png" alt="Best Property dealers " />-->
...
<section class="module properties">
  <div class="container">
    ...
    <div class="row">
        ...
        @foreach($com_rentsell_properties as $crp => $com_rentsell_property)
        @if($crp < 3)
        <div class="col-lg-4 col-md-4">
          <div class="property shadow-hover">
            <a href="{{ route('front-properties-detail', $com_rentsell_property->cat_slug, $com_rentsell_property->slug) }}" class="property-img">
              <div class="img-fade"></div>
              <div class="property-color-bar"></div>
              <img src="{{ $com_rentsell_property->property_images }}" alt="Best real-estate agent" />
            </a>
          </div>
        </div>
        @endif
