            ...
            <div class="row">
                <div class="col-md-6">
                  ...
                  <div style="padding-top:40px;"> 
                    ...
                    <p>This Data Analytics course is designed to provide participants with the skills and knowledge needed to analyze data effectively, extract insights, and make data-driven decisions. The course covers various tools and techniques used in data analytics, including data manipulation, visualization, statistical analysis, and machine learning.</p>
                  </div> 
