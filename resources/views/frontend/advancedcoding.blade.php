...
@media (max-width: 960px) {
            ...
            <div class="row">
                <div class="col-md-6">
                     <ul class="bg-transparent breadcrumb">
                        ...
                        <li class="active"> / Advanced Excel Course</li>
                    </ul>
                  
                  <div style="padding-top:40px;"> 
                    <h1>Advanced Excel Course</h1>
  ...
  <div class="col-lg-4 col-md-6 col-12 sidebar" position: relative;z-index: 2; padding:20px">
                    <!-- Single Item -->
                    <div class="item course-preview">
                        <div class="thumb">
                            <img src="https://images.pexels.com/photos/414628/pexels-photo-414628.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Thumb" class="img-fluid">
