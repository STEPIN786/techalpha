...
<head>
            ...
            <div class="container-full">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}">
                        ...
                        <img src="{{ asset('assets/img/iso.png') }}"
                            style="padding-left: 31px;height: 58px !important;" class="logo" alt="Logo">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right navigation " data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="dropdown desktop-view-courses">
                            ...
                            <ul class="megamenu ">
                                <li><a href="{{ url('/python') }}">Python Full Stack Developer</a>
                                </li>

                                <li><a href="{{ url('/hardware') }}">Hardware</a></li>
                                <li><a href="{{ url('/data-analytic') }}">Data Analytics </a></li>
                                <li><a href="{{ url('/graphicdesign') }}">Graphics Designing</a>
                                </li>
                                ...
                                <li><a href="{{ url('/digitalmarketing') }}">digital Marketing</a>
                                </li>
    ...
    <!-- Modal -->
    <div class="modal fade register-popup" id="exampleModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    <form action="" method="POST" class="contact-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input class="form-control" id="password" name="username" placeholder="Password"
                                        type="password">
                                    <span class="alert-error"></span>
                                </div>
                            </div>
    ...
    <!-- Modal -->
    <div class="modal fade register-popup" id="exampleModal1" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-content" style="background:white;">
                    <div class="modal-header" style="padding:20px;">
                        <button type="button" class="close" data-dismiss="modal" aria-label=""
                            style="opacity: .9 !important;">
                            <span
                                style="position: absolute; right: 20px; top: 2px; font-size: 40px; color: #000;filter: alpha(opacity=100) !important;opacity: .9 !important;">×</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="thank-you-pop text-center">
                            <img src="https://techalphainstitute.com/public/assets/img/logo.png" alt="">
                            <h3 class="mt-3">Thank you for submitting your query.We will get back to you very soon</h3>
                        </div>
                    </div>
                </div>
            </div>
