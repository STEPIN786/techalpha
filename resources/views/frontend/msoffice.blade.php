            ...
            <div class="col-md-6">
                ...
                <div style="padding-top:40px;">
                    ...
                    <p>MS-Office course trains students how to use MS-Office applications
                        in office work such as creating professional- quality documents, store, organize and analyze
                        information, arithmetic operations and functions and create dynamic
                        slide presentations with animation, narration, images, and much more, digitally and effectively.
                    </p>
                </div>
        ...
        <div class="row">
            <div class="col-lg-8 info">
                ...
                <div class="course-overview" id="overview" style="padding-top: 100px; margin-top: -50px;">
                    ...
                    <p>MS-Office course trains students how to use MS-Office applications in office work such as
                        creating professional- quality documents, store, organize and analyze information,
                        arithmetic operations and functions and create dynamic slide presentations with animation,
                        narration, images, and much more, digitally and effectively.</p>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                ...
                @honeypot
                    ...
                    <div class="form-group">
                    <input type="hidden" name="course" value="MS Office" />
