   ...
   <div class="row">
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="card-body">
               <form class="forms-sample" method="POST" action="<?php echo e(route('product.store')); ?>" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                  <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="phone" type="text" class="form-control phonefilter" name="phone" value="" placeholder="Enter phone">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="title" type="text" class="form-control" name="title" value="" placeholder="Enter Title" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="map_link" type="text" class="form-control" name="map_link" value="" placeholder="Map Link">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="video_link" type="text" class="form-control" name="video_link" value="" placeholder="Video Link">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="price" type="text" class="form-control pricefilter" name="price" value="" placeholder="Rate / Rent">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <textarea class="form-control" type="text" id="address" name="address" rows="4"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <textarea class="form-control txteditor" type="text" id="description" name="description" rows="4"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                           ...
                           <textarea class="form-control txteditor" type="text" id="additional_details" name="additional_details" rows="4"></textarea>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mujahidenterpris/public_html/realestate/resources/views/admin/product/create.blade.php ENDPATH**/ ?>