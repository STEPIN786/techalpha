<head>
  ...
  <!-- CSS file links -->
  <link href="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/css/bootstrap.min.css" rel="stylesheet" media="screen">
  <link href="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/assets/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" media="screen">
  <link href="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/assets/jquery-ui-1.12.1/jquery-ui.min.css" rel="stylesheet">
  <link href="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/assets/slick-1.6.0/slick.css" rel="stylesheet">
  <link href="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/assets/chosen-1.6.2/chosen.min.css" rel="stylesheet">
  <link href="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/css/nouislider.min.css" rel="stylesheet">
  <link href="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/css/style.css" rel="stylesheet" type="text/css" media="all" />
  <link href="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/css/responsive.css" rel="stylesheet" type="text/css" media="all" />
...
<link href="https://fonts.googleapis.com/css2?family=Work+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,500;1,600&display=swap" rel="stylesheet">
  ...
  <!--[if lt IE 9]>
      <script src="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/js/html5shiv.min.js"></script>
      <script src="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/js/respond.min.js"></script>
  <![endif]-->
   <script src="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/js/nouislider.min.js"></script>
...
<header class="header-default">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
          ...
          <table>
            <tr>
              ...
              <td class="header-item-text">
                Call us anytime<br/>
                <span>+91 8888397777 / +91 9890239777</span>
              </td>
            </tr>
          </table>
        </div>
        <div class="header-item header-phone left">
          <table>
            <tr>
              ...
              <td class="header-item-text">
                Drop us a line<br/>
                <span><a href="mailto:luckeeproperties@gmail.com">info@luckeeproperties.in</a></span>
              </td>
            </tr>
          </table>
        </div>
      ...
      <a class="navbar-brand" href="<?php echo e(route('front-home')); ?>"><img src="<?php echo e(env('ASSET_URL1')); ?>/public/frontend/images/l-logo.png" alt="Luckee Properties" /></a>
    ...
    <div class="navbar-collapse collapse">
      <div class="main-menu-wrap">
        ...
        <div class="member-actions right">
          <a href="<?php echo e(route('front-contact')); ?>" class="button small alt button-icon"></i>Sell / Rent Your Property</a>
        </div>
        <ul class="nav navbar-nav right">
          ...
          ?>
          <?php $__currentLoopData = $head_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $head_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <li>
            <a href="<?php echo e(route('front-properties-list', $head_category->slug)); ?>"><?php echo e($head_category->title); ?></a>
          </li>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

          <li>
            <a href="<?php echo e(route('front-buy-list')); ?>">Buy</a>
          </li> 
          <li>
            <a href="<?php echo e(route('front-rent-list')); ?>">Rent</a>
          </li>
         
          <li><a href="<?php echo e(route('front-blog-list')); ?>">Blogs</a></li>
...
<?php /**PATH /home1/mujahidenterpris/public_html/realestate/resources/views/frontend/include/header.blade.php ENDPATH**/ ?>