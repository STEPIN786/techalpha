...
<?php $__env->startSection('content'); ?>
    ...
    <h1 class="text-center">Welcome Back Chief 😊</h1>
                    ...
                    <div class="card-block">
                        <div class="align-middle mb-25">
                            ...
                            <div class="d-inline-block">
                                <a href="#!">
                                    <h6><?php echo e(__('Alex Thompson')); ?></h6>
                                </a>
                        ...
                        <div class="align-middle mb-25">
                            ...
                            <div class="d-inline-block">
                                ...
                                <span class="status deactive text-mute"><i
                                        class="far fa-clock mr-10"></i><?php echo e(__('30 min ago')); ?></span>
                            </div>
                        </div>
                        <div class="align-middle mb-25">
                            ...
                            <div class="d-inline-block">
                                ...
                                <p class="text-muted mb-0"><?php echo e(__('Cheers!')); ?></p>
                                <span class="status deactive text-mute"><i
                                        class="far fa-clock mr-10"></i><?php echo e(__('10 min ago')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/mujahidenterpris/public_html/realestate/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>