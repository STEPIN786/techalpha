...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', ''); ?> | Luckee Properties</title>
    ...
    <div class="wrapper">
        ...
        <div class="page-wrap">
            ...
            <div class="main-content">
                ...
                <!-- yeild contents here -->
            <?php echo $__env->make('include.alertmessage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home1/mujahidenterpris/public_html/realestate/resources/views/layouts/main.blade.php ENDPATH**/ ?>